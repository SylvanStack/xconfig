package com.yuanstack.xconfig.client.util;
...
/**
 * @author Sylvan
 * @date 2024/05/19  17:31
 */
public interface HttpUtils {

    Logger log = LoggerFactory.getLogger(HttpUtils.class);

    HttpUtils.HttpInvoker Default = new HttpUtils.OkHttpInvoker();

    static HttpUtils.HttpInvoker getDefault() {
        if(((HttpUtils.OkHttpInvoker)Default).isInitialized()) {
            return Default;
        }
        ...
        ((HttpUtils.OkHttpInvoker)Default).init(timeout, maxIdleConnections, keepAliveDuration);
        return Default;
    }
...
//        void init(int timeout);
    ...
    @Slf4j
    class OkHttpInvoker implements HttpUtils.HttpInvoker {
    ...
    static void main(String[] args) {
        ...
        System.out.println(httpGet("https://httpbin.org/get", HttpUtils.HttpBin.class));
    }
